...
public class AdminRoleController extends BaseController {
    ...
    public Result<?> updatePermission(@RequestBody @Validated(AdminRoleFormVO.UpdatePermission.class) AdminRoleFormVO adminRoleFormVO, BindingResult result) {
        validate(result);
        return adminRoleService.updateRolePermission(adminRoleFormVO);
    }

    @GetMapping("delete")
    public Result<?> delete(@RequestParam("id") @NotEmpty(message = CommonsFormValidateConstants.ID_NOT_NULL_MSG) List<Long> ids) {
