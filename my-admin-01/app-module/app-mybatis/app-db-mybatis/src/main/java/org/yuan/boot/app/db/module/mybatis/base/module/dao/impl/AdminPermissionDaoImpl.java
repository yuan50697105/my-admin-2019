...
import org.yuan.boot.app.db.module.mybatis.base.module.mapper.AdminPermissionMapper;
...
public class AdminPermissionDaoImpl extends BaseDaoImpl<AdminPermission, AdminPermissionMapper> implements AdminPermissionDao {
    ...
    @Override
    public PageResult<AdminPermission> selectPage(AdminPermissionQuery condition) {
        PageHelper.startPage(condition);
        return new PageResult<>(PageInfo.of(baseMapper.selectByQueryCondition(condition)));
    }

    @Override
    public List<AdminPermission> selectList(AdminPermissionQuery condition) {
