...
import org.yuan.boot.app.db.module.mybatis.base.module.mapper.AdminRolePermissionMapper;
...
public class AdminRolePermissionDaoImpl extends BaseDaoImpl<AdminRolePermission, AdminRolePermissionMapper> implements AdminRolePermissionDao {
    ...
    @Override
    public AdminRoleWithPermissionDTO getRolePermissionByRoleId(Long roleId) {
        ...
        return new AdminRoleWithPermissionDTO(adminRole, adminPermissions);
