...
import org.yuan.boot.app.db.module.mybatis.jooq.sqlhelper.plus.module.dao.AdminUserDao;
import org.yuan.boot.app.db.module.mybatis.jooq.sqlhelper.plus.module.dao.AdminUserRoleDao;
import org.yuan.boot.app.db.module.mybatis.jooq.sqlhelper.plus.module.mapper.AdminUserRoleMapper;
...
public class AdminUserRoleDaoImpl extends BaseDaoImpl<AdminUserRole, AdminUserRoleMapper> implements AdminUserRoleDao {
    ...
    public AdminUserRoleVO getUserRoleByUserId(Long userId) {
        ...
        Collection<AdminRole> adminRoles = Collections.emptyList();
        if (!roleIds.isEmpty()) {
