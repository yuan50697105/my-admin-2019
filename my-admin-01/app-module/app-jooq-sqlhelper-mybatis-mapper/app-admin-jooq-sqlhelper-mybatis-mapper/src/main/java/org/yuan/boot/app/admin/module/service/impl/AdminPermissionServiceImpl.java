...
public class AdminPermissionServiceImpl implements AdminPermissionService {
    ...
    public Result<?> update(AdminPermissionFormVO adminPermissionFormVO) {
        AdminPermission adminPermission = adminPermissionDao.selectByPrimaryKey(adminPermissionFormVO.getId());
        if (adminPermission != null) {
            adminPermission.copyFrom(adminPermissionFormVO, AdminPermission.class);
            adminPermissionDao.updateByPrimaryKeySelective(adminPermission);
        }
        return Result.ok();
    }
    ...
    public Result<?> get(Long id) {
        AdminPermission adminPermission = adminPermissionDao.selectByPrimaryKey(id);
