...
public class WxUserServiceImpl implements WxUserService {
    ...
    @SneakyThrows
    private ResponseResult getOpenIdByAuthCode(String authCode) {
        
        return null;
    }

    @Override
    public ResponseResult getInfoByOpenId(String openId) {

        return null;
    }

    @Override
    public ResponseResult getOrderInfoByOpenId(String openId) {
        return null;
    }
