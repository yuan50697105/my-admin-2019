...
import org.yuan.boot.db.DbMybatisSqlHelperApplication;
...
@SpringBootApplication(scanBasePackageClasses = {WebMvcCoreApplication.class, DbCoreApplication.class, DbMybatisSqlHelperApplication.class})
