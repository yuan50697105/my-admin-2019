...
public class SysRoleServiceImpl implements SysRoleService {
    ...
    public ResponseResult selectPage(SysRoleCondition condition) {
        return data(sysRoleDao.selectPage(condition));
    }

    @Override
    public ResponseResult selectList(SysRoleCondition condition) {
        return data(sysRoleDao.selectList(condition));
    }

    @Override
    public ResponseResult selectOne(SysRole sysRole) {
        return data(sysRoleDao.selectOne(sysRole));
    }
    ...
    public ResponseResult save(SysRoleVo sysRoleVo) {
        ...
        if (optional.isPresent()) {
            throw new ExistResultRuntimeException(ResponseResults.existError("name已存在"));
        }
