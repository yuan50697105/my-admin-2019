...
public class SysPermissionController extends ResultController {
    ...
    public ResponseResult data(SysPermissionCondition condition) {
    ...
    public ResponseResult get(SysPermission permission) {
    ...
    public ResponseResult save(SysPermissionVo sysPermissionVo, BindingResult result) {
        validate(result);
    ...
    public ResponseResult update(SysPermissionVo sysPermissionVo, BindingResult result) {
        validate(result);
